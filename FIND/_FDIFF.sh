...
echo  "DIFF -y supress "  "${D1} "    ${D2}

diff  -Bw -y --suppress-common-lines  $D1 $D2
...
echo  "DIFF -y allline left "  "${D1} "    ${D2}
diff  -Bw -y --left-column $D1 $D2
